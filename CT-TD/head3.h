...
//    vector<unordered_map<int,set<int>>> PruningPoint;//<<nodeID,supportNode>,prunedHubs> and <<prunedHubs,supportNode>,nodeID>
	vector<unordered_map<int,vector<int>>> PruningPointNew;//v {c,{u}}
    vector<unordered_map<int,list<int>>> PruningPointList;//v {c,{u}}, must use vector/list to record the pruning point
    ...
    void IncreasePLL(int a, int b, int oldW, int newW, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label,vector<unordered_map<int,list<int>>> &PruningPointNew);
    ...
    //BVC-PLL
    void BVCIndexConstructMThread();
    bool BVCDhopLableRefreshMulti(vector<int>& bNodes, int step);
    void threadDistribute2(vector<int>& bNodes, vector<vector<int>>& processID);
    ...
    void IncreasePSL(int a, int b, int oldW, int newW, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label,vector<unordered_map<int,list<int>>> &PruningPointNew);//list version without NoSupportedPair
    void IncreasePSL2(int a, int b, int oldW, int newW, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label,vector<unordered_map<int,list<int>>> &PruningPointNew);//list version with NoSupportedPair
    void IncreasePSL(int a, int b, int oldW, int newW, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label,vector<unordered_map<int,vector<int>>> &PruningPointNew);//vector version with NoSuportedPair
	void IncreasePSL(int a, int b, int oldW, int newW, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label,vector<unordered_map<int,vector<int>>> &PruningPointNew,set<pair<int,int>> &NoSupportedPair);//original version, vector with NoSupportedPair
    ...
    int DisQueryVally2(int ID1, int ID2, int ID3, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label);
    int DisQueryVallyVert2(int ID1, int ID2, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label,int oldW);
    int DisQueryVallyVert(int ID1, int ID2, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label);
    int DisQueryVallyNew(int ID1, int ID2, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label);
	int DisQueryVally(int ID1, int ID2, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label);
    int DisQueryVallyDebug(int ID1, int ID2, vector<vector<pair<int,int>>> &Neighbors,vector<unordered_map<int,int>> &Label);
    pair<int,set<int>> DisQueryPeak2Vert2(int ID1, int ID2, vector<vector<pair<int,int>>> &Neighbors, vector<unordered_map<int,int>> &Label);
    pair<int,set<int>> DisQueryPeak22(int ID1, int ID2,vector<unordered_map<int,int>> &Label);
    pair<int,int> DisQueryPeak2Vert(int ID1, int ID2, vector<vector<pair<int,int>>> &Neighbors, vector<unordered_map<int,int>> &Label);
    pair<int,int> DisQueryPeak2(int ID1, int ID2,vector<unordered_map<int,int>> &Label);
...
//    void makeIndexDFS(int p, vector<int> &list);
    ...
    void Construct_core(int indexType);//0 indicates using PLL, 1 indicates using PSL
