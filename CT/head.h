...
public:
	...
	void DecreaseH2H(int a,int b, int newW, vector<vector<pair<int,int>>> &Neighbors, vector<Node> &Tree, vector<int> &rank, int heightMax);
//    void DecreaseH2H(int a,int b, int newW, unordered_map<int,vector<pair<int,int>>> &Neighbors, vector<Node> &Tree, vector<int> &rank, int heightMax);
	...
	void IncreaseH2H(int a, int b, int oldW, int newW, vector<vector<pair<int,int>>> &Neighbors, vector<Node> &Tree, vector<int> &rank, int heightMax,vector<map<int, vector<int>>> &SCconNodesMT, vector<vector<int>> &VidtoTNid);
